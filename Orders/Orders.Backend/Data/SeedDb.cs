...
namespace Orders.Backend.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("0013", "Eider", "Fuentes", "eider@yopmail.com", "314 398 5106", "Calle Luna Calle Sol", "Eider.jpg", UserType.Admin);
        ...
        private async Task CheckProductsAsync()
        {
            if (!_context.Products.Any())
            {
                ...
                await AddProductAsync("Huevos Tipo Jumbo", 24000M, 5000F, new List<string>() { "Comida" }, new List<string>() { "huevos_tipo_jumbo.jpg" });
                await AddProductAsync("Huevos Tipo AA", 18000M, 1000F, new List<string>() { "Comida" }, new List<string>() { "huevos_tipo_AA.png" });
                await AddProductAsync("Huevos Tipo A", 15000M, 3000F, new List<string>() { "Comida" }, new List<string>() { "huevos_tipo_A.png" });
                await AddProductAsync("Huevos Tipo B", 13000M, 5000F, new List<string>() { "Comida" }, new List<string>() { "huevos_tipo_B.png" });
